/*
	Edited and cut down extremely by Paul Barker (PaulB0100@aol.com)
	for COS
	
	First Modified:	04/08/04
...
// we cannot do output to screen yet
#define printf
#define sprintf
...
// Lets see how this works for a faster kernel
...
// Will never use LINT so removed stuff
